---
description: Set up the wn Claude Code plugin — installs wn if needed, configures the tmux-claude launcher script, and walks through wn settings. Re-run at any time to reconfigure.
---
...
## Step 3: Configure launcher script install location
...
## Step 4: Configure settings template auto-update
...
## Step 5: Write config and install files
